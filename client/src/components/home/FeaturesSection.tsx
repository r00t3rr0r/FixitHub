          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 group-hover:bg-white/15 transition-all duration-300"></div>
                ...
                <div className="relative p-8 text-center">
                  ...
                  <div className="mb-6 flex justify-center">
                    <div className="relative">
                      ...
                      <div className="relative w-16 h-16 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="mt-4 h-1 bg-gradient-to-r from-transparent via-yellow-400 to-transparent rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></div>
                </div>
              </div>
            </div>
          ))}
