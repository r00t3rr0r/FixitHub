              ...
              <div className="space-y-3">
                <div className="overflow-hidden rounded-xl border border-[#d8dce6] bg-[#eef3fb]">
                  {primaryImage ? (
                    <img
                      src={primaryImage}
                      alt={deviceLabel}
                      className="h-44 w-full bg-[#eef3fb] p-3 object-contain"
                      onError={(event) => {
                  ...
                  <div className={`${primaryImage ? "hidden" : "flex"} h-44 items-center justify-center`}>
                    <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-[#1a2a5e] shadow-sm">
                ...
                <div className="rounded-xl border border-[#d8dce6] bg-[#f8f9fc] p-3">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="whitespace-nowrap text-lg font-bold text-[#1a2a5e]">
                      {((order.totalCost || 0) * quantity).toFixed(2)} €
                    </span>
                  </div>
                  {quantity > 1 && (
                    <p className="mt-1 whitespace-nowrap text-[11px] text-[#636e85]">
                      ...
                      {addOnEntries.length > 0 ? (
                        addOnEntries.map((addOn, index) => (
                          <div key={`${addOn.name}-${index}`} className="rounded-lg bg-[#f8f9fc] px-3 py-2">
                            <div className="flex items-center justify-between gap-3">
                              <span className="flex items-center gap-2 text-sm font-semibold text-[#1a2a5e]">
                  ...
                  <div className="rounded-xl border border-[#d8dce6] bg-white">
                    ...
                    <div className="px-3 py-3">
                      <div className="rounded-lg bg-[#f8f9fc] px-3 py-2.5">
                        ...
                        <p className="text-sm leading-5 text-[#1a2a5e]">{getUnlockValue(order)}</p>
                      </div>
                    </div>
                  </div>
                </section>
