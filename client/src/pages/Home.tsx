      ...
      <header className="border-b sticky top-0 z-50 bg-white/95 backdrop-blur shadow-sm">
        <div className="container mx-auto px-4 py-2.5 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="text-lg font-bold text-gray-900 hidden sm:inline-block group-hover:text-yellow-600 transition-colors duration-200">
              FixitHub
            </span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-5">
            <a
              href="#services"
              className="text-sm text-gray-600 hover:text-yellow-600 transition-colors duration-200 font-medium relative group"
            >
              {t('home.nav.services')}
            ...
            {isAuthenticated ? (
              ...
              <>
                <Button
                  variant="outline"
                  asChild
                  className="hidden sm:inline-flex text-sm h-9 border-gray-300 hover:border-yellow-400 hover:text-yellow-600 transition-all duration-200"
                >
                  <Link to="/login">{t('navigation.login')}</Link>
                </Button>
                <Button
                  asChild
                  className="text-sm h-9 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold shadow-md hover:shadow-lg transition-all duration-200"
                >
      ...
      <footer className="py-10 border-t bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
              <h3 className="font-semibold text-sm mb-3">{t('home.footer.servicesTitle')}</h3>
            ...
            <div>
              <h3 className="font-semibold text-sm mb-3">{t('home.footer.companyTitle')}</h3>
              <ul className="space-y-1.5 text-sm text-gray-400">
            ...
            <div>
              <h3 className="font-semibold text-sm mb-3">{t('home.footer.supportTitle')}</h3>
              <ul className="space-y-1.5 text-sm text-gray-400">
